/**
 * EvalPanel — side drawer for managing evaluation datasets and viewing results.
 */
...
import type { EvalStore } from "@/store/useEvalStore";

const { Text, Title } = Typography;

export interface EvalPanelProps extends EvalStore {
  onClose: () => void;
}
